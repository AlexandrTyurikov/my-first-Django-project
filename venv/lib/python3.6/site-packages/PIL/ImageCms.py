...
def profileToProfile(
    ...
    :param im: An open PIL images object (i.e. Image.new(...) or
        Image.open(...), etc.)
    ...
    :returns: Either None or a new PIL images object, depending on value of
        inPlace
...
def applyTransform(im, transform, inPlace=False):
    ...
    :returns: Either None, or a new PIL Image object, depending on the value of
        inPlace. The profile will be returned in the images's
        info['icc_profile'].
    :exception PyCMSError:
    """
