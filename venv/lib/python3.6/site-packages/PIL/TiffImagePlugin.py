...
# book is placed first in the file.
#
# History:
...
class ImageFileDirectory_v2(MutableMapping):
    """This class represents a TIFF tag book.  To speed things up, we
    don't decode tags unless they're asked for.

    Exposes a dictionary interface of the tags in the book::
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    """This class represents the **legacy** interface to a TIFF tag book.
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        # images file book (tag dictionary)
    ...
    def size(self, value):
        warnings.warn(
            'Setting the size of a TIFF images directly is deprecated, and will'
    ...
    def _load_libtiff(self):
        ...
        if self.tile is None:
            raise IOError("cannot load this images")
        if not self.tile:
            return pixel
        ...
        try:
            ...
            raise IOError("Couldn't set the images")
...
def _save(im, fp, filename):
    ...
    if libtiff:
        ...
        atts = {}
        # bits per sample is a single short in the tiff book, not a list.
        ...
        while True:
            ...
            if s:
                break
        if s < 0:
            raise IOError("encoder error %d when writing images file" % s)
