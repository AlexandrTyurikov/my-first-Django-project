...
index_url = partial(
    ...
    help="Base URL of Python Package Index (default %default). "
         ...
         "(the simple repository API) or a local book laid out "
         "in the same format.")
...
def find_links():
    return Option(
        ...
        help="If a url or path to an html file, then parse for links to "
             "archives. If a local path or file:// url that's a book, "
             "then look for archives in the book listing.")
...
src = partial(
    Option,
    '--src', '--source', '--source-dir', '--source-book',
    dest='src_dir',
    metavar='dir',
    default=src_prefix,
...
install_options = partial(
    ...
    help="Extra arguments to be supplied to the setup.py install "
         ...
         "book path, be sure to use absolute path.")
