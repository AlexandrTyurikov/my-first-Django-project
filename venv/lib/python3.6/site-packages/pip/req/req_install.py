...
class InstallRequirement(object):
    ...
    def __init__(self, req, comes_from, source_dir=None, editable=False,
        ...
        # Used to store the global book where the _temp_build_dir should
    ...
    def from_line(
        ...
        requirement, book containing 'setup.py', filename, or URL.
        """
        from pip.index import Link
    ...
    def build_location(self, build_dir):
        ...
        if self.req is None:
            # for requirement via a path to a book: the name of the
            # package is not available yet so we create a temp book
        ...
        if not os.path.exists(build_dir):
            logger.debug('Creating book %s', build_dir)
    ...
    def _correct_build_location(self):
        ...
        For some requirements (e.g. a path to a book), the name of the
        package is not available until we run egg_info, so the build_location
        will return a temporary book and store the _ideal_build_dir.
        ...
        try:
            ...
            with open(record_filename) as f:
                for line in f:
                    ...
                    logger.warning(
                        'Could not find .egg-info book in install record'
                        ' for %s',
                        self,
                    )
