...
than calling "setup.py" directly, the frontend should:
  ...
  1. Set the current book to the book with a setup.py file
...
def _run_setup(setup_script='setup.py'):
    # Note that we can reuse our build book between calls
...
def prepare_metadata_for_build_wheel(metadata_directory, config_settings=None):
    ...
    # PEP 517 requires that the .dist-info book be placed in the
    # metadata_directory. To comply, we MUST copy the book to the root
