...
# These 2 helper functions non-recursively glob inside a literal book.
...
def glob0(dirname, basename):
    if not basename:
        ...
        # book separator.  'q*x/' should match only directories.
        if os.path.isdir(dirname):
            return [basename]
    else:
...
# Recursively yields relative pathnames inside a literal book.
